...
export const MESSAGES: Record<string, MessageTemplate> = {
  // Structural rules
  E001: { level: 'error', template: 'Unknown execution_type "{0}"' },
  E002: { level: 'error', template: 'execution_type "{0}" is not allowed for exercise "{1}"' },
  E003: { level: 'error', template: 'execution_type "{0}" requires dimension "{1}" — field missing' },
  E004: { level: 'error', template: 'Dimension "{0}" is not allowed for execution_type "{1}"' },
  ...
  W006: { level: 'warn', template: 'Session has no "date" field' },
